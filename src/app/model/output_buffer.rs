...
impl OutputBuffer {
    // Creates a new OutputBuffer with the specified maximum number of lines.
    ...
    // Adds a new output line to the buffer, evicting the oldest line if necessary.
    ...
    // Returns the current length of lines in the buffer.
    pub fn line_length(&self) -> usize {
        self.lines.len()
    }

    // Returns a slice of lines starting from `start` index with the specified `size`.
...
mod tests {
    ...
    fn test_max_lines_limit() {
        ...
        buffer.push_line(OutputLine::new("Line 1"));
        buffer.push_line(OutputLine::new("Line 2"));
        buffer.push_line(OutputLine::new("Line 3"));
        assert_eq!(buffer.lines().len(), 3);

        // 4th line should evict the first line
        buffer.push_line(OutputLine::new("Line 4"));
        assert_eq!(buffer.lines().len(), 3);
    ...
    fn test_max_lines_eviction_order() {
        ...
        buffer.push_line(OutputLine::new("First"));
        buffer.push_line(OutputLine::new("Second"));
        buffer.push_line(OutputLine::new("Third"));
    ...
    fn test_lines_accessor() {
        ...
        buffer.push_line(OutputLine::new("Test"));
    ...
    fn test_slice_lines_from_start() {
        ...
        buffer.push_line(OutputLine::new("Line 3"));
        buffer.push_line(OutputLine::new("Line 4"));
        buffer.push_line(OutputLine::new("Line 5"));
    ...
    #[test]
    fn test_lines_length() {
        let mut buffer = OutputBuffer::new(10);
        assert_eq!(buffer.line_length(), 0);

        buffer.push_line(OutputLine::new("Line 1"));
        assert_eq!(buffer.line_length(), 1);

        buffer.push_line(OutputLine::new("Line 2"));
        assert_eq!(buffer.line_length(), 2);
    }
}
